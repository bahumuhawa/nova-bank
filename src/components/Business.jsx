  ...
  <section id="features" className={layout.section}>
    <div className={layout.sectionInfo}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        With an ideal credit card, you can improve your financial life by
        building credit, earning rewards, and saving money. However, with
        numerous credit cards on the market, choosing the right one can be
        challenging.
      </p>
